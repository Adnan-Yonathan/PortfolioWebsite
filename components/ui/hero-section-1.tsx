    ...
    <>
      ...
      <main className="overflow-hidden">
        <div className="relative isolate pt-24 md:pt-36">
          <div
            aria-hidden
            className="z-[2] absolute inset-0 pointer-events-none opacity-50 hidden lg:block"
          >
            <div className="absolute left-0 top-0 h-[80rem] w-[35rem] -translate-y-[350px] -rotate-45 rounded-full bg-[radial-gradient(68.54%_68.72%_at_55.02%_31.46%,hsla(0,0%,85%,.08)_0,hsla(0,0%,55%,.02)_50%,transparent_80%)]" />
          ...
          <div className="mx-auto max-w-7xl px-6">
            <div className="text-center sm:mx-auto lg:mr-auto lg:mt-0">
              <AnimatedGroup variants={transitionVariants}>
                <div className="mx-auto flex w-fit items-center gap-4 rounded-full border border-white/10 bg-white/5 px-4 py-2 text-xs uppercase tracking-[0.3em] text-slate-300 shadow-lg shadow-black/30 ring-1 ring-white/10">
                  <span className="text-foreground text-sm">
                    Web design for home services, agencies & software
                  </span>
                  <div className="dark:border-background block h-4 w-0.5 border-l bg-white dark:bg-slate-700" />
                  <div className="flex h-6 w-6 items-center justify-center rounded-full border border-white/20 bg-slate-900">
                    <ArrowRight className="h-3 w-3" />
                  </div>
                </div>

                <h1 className="mt-10 max-w-4xl mx-auto text-balance text-5xl md:text-6xl lg:mt-16 xl:text-[4.75rem]">
                  Modern web experiences for operators who run teams and products
                </h1>
                <p className="mx-auto mt-8 max-w-2xl text-balance text-lg text-slate-300">
                  Studio Elemental pairs grounded research and crafted visuals so
                  agencies, home service brands, and SaaS studios launch clearer,
                  more confident digital platforms.
                </p>
              </AnimatedGroup>
              ...
              >
                ...
                >
                  <Link href="#contact">
                    <span className="text-nowrap">Request a proposal</span>
                  </Link>
                </Button>
              </AnimatedGroup>
            </div>
        ...
        >
          <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
            <div className="flex w-full justify-between lg:w-auto">
              ...
              >
                <Logo />
                <span className="text-sm uppercase tracking-[0.4em]">Studio Elemental</span>
              </Link>
              <button
              ...
              >
                <Menu className="group-data-[state=active]:rotate-180 duration-200" />
                <X className="group-data-[state=active]:rotate-0 group-data-[state=active]:scale-100 absolute inset-0 m-auto size-6 -rotate-180 scale-0 opacity-0 duration-200" />
              </button>
            </div>

            <div className="absolute inset-0 m-auto hidden size-fit lg:block">
              <ul className="flex gap-8 text-sm uppercase tracking-[0.3em]">
            ...
            <div className="hidden w-full justify-end gap-6 lg:flex">
